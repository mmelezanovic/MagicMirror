!(function (t, e, n) {
			...
			function (t, e) {
				...
				(s.prototype.left = function () {
					...
					(s.prototype.center = function () {
						...
						var t = i.create();
						return this.lerp(t, 0.5), (this._center = t), t;
					}),
			...
			function (t, e) {
				...
				(o.defaultProtocolVersion = 6),
					...
					(o.prototype.disconnect = function (t) {
						return (
							t || this.stopReconnection(),
							this.socket
								? (this.socket.close(), delete this.socket, delete this.protocol, delete this.background, delete this.optimizeHMD, delete this.focusedState, this.connected && ((this.connected = !1), this.emit("disconnect")), !0)
								: void 0
						);
					}),
		...
		4: [
			function (t, e) {
				...
				i.extend(r.prototype, n.prototype),
					(r.__proto__ = n),
					(r.prototype.useSecure = function () {
						...
						if (!this.focusDetectorTimer) {
							...
							(e =
								"undefined" != typeof document.hidden
									...
									? "webkitHidden"
									: void 0),
								void 0 === t.windowVisible && (t.windowVisible = void 0 === e ? !0 : document[e] === !1);
			...
			function (t, e) {
				var n = t("__browserify_process"),
					...
					f = (e.exports = function (e) {
						...
						(e = p.defaults(e || {}, {
							...
							(this.onAnimationFrame = function (t) {
								o.lastConnectionFrame.valid && o.emit("animationFrame", o.lastConnectionFrame),
									o.emit("frameEnd", t),
									o.loopWhileDisconnected && (o.connection.focusedState !== !1 || o.connection.opts.background) ? window.requestAnimationFrame(o.onAnimationFrame) : (o.animationFrameRequested = !1);
							}),
							(this.suppressAnimationLoop = e.suppressAnimationLoop),
							(this.loopWhileDisconnected = e.loopWhileDisconnected),
							(this.frameEventName = e.frameEventName),
							(this.useAllPlugins = e.useAllPlugins),
							(this.history = new a(200)),
							(this.lastFrame = i.Invalid),
							(this.lastValidFrame = i.Invalid),
							(this.lastConnectionFrame = i.Invalid),
							(this.accumulatedGestures = []),
							(this.checkVersion = e.checkVersion),
							(this.connectionType = void 0 === e.connectionType ? t(this.inBrowser() ? "./connection/browser" : "./connection/node") : e.connectionType),
							(this.connection = new this.connectionType(e)),
							(this.streamingCount = 0),
							(this.devices = {}),
							(this.plugins = {}),
							(this._pluginPipelineSteps = {}),
							(this._pluginExtendedMethods = {}),
							e.useAllPlugins && this.useRegisteredPlugins(),
							this.setupFrameEvents(e),
				...
				(f.prototype.gesture = function (t, e) {
					...
					(f.prototype.setupConnectionEvents = function () {
						...
						this.connection.on("focus", function () {
							...
							this.connection.on("deviceEvent", function (e) {
								...
								(t.devices[n.id] = n),
									r.attached && t.emit(n.attached ? "deviceAttached" : "deviceRemoved", n),
									r.streaming &&
										(n.streaming
											? (t.streamingCount++, t.emit("deviceStreaming", n), 1 == t.streamingCount && t.emit("streamingStarted", n), r.attached || t.emit("deviceConnected"))
											: (r.attached && n.attached) || (t.streamingCount--, t.emit("deviceStopped", n), 0 == t.streamingCount && t.emit("streamingStopped", n), t.emit("deviceDisconnected")));
							}),
					...
					(f.prototype.checkOutOfDate = function () {
						...
						return n > e
							? (console.warn("Your Protocol Version is v" + e + ", this app was designed for v" + n),
							  h.warnOutOfDate({
									sV: t,
									pV: e
							  }),
				...
				var d = function (t, e, n) {
						-1 != ["beforeFrameCreated", "afterFrameCreated"].indexOf(e)
							? this.on(e, n)
							: (this.pipeline || (this.pipeline = new u(this)), this._pluginPipelineSteps[t] || (this._pluginPipelineSteps[t] = []), this._pluginPipelineSteps[t].push(this.pipeline.addWrappedStep(e, n)));
					},
					m = function (t, e, n) {
						var a;
				...
				(f.prototype.use = function (t, e) {
					...
					(f.prototype.stopUsing = function (t) {
						var e,
							n,
							i = this._pluginPipelineSteps[t],
							r = this._pluginExtendedMethods[t],
							o = 0;
						if (this.plugins[t]) {
							if (i) for (o = 0; o < i.length; o++) this.pipeline.removeStep(i[o]);
							if (r)
			...
			function (t, e) {
				...
				(i.prototype.createElement = function () {
					...
					this.element.appendChild(t),
						(t.style.className = "leapjs-dialog"),
						...
						(t.style.transition = "box-shadow 1s linear"),
						(t.innerHTML = this.message),
						this.options.onclick && t.addEventListener("click", this.options.onclick),
						this.options.onmouseover && t.addEventListener("mouseover", this.options.onmouseover),
						this.options.onmouseout && t.addEventListener("mouseout", this.options.onmouseout),
						this.options.onmousemove && t.addEventListener("mousemove", this.options.onmousemove);
				}),
						...
						return (
							(r = new i(s, {
								...
								onmousemove: function (t) {
									t.target == document.getElementById("leapjs-decline-upgrade")
			...
			function (t, e) {
				var n = t("./pointable"),
					...
					s = (e.exports = function (t) {
						n.call(this, t),
							(this.dipPosition = t.dipPosition),
							(this.pipPosition = t.pipPosition),
							(this.mcpPosition = t.mcpPosition),
							(this.carpPosition = t.carpPosition),
							(this.extended = t.extended),
							(this.type = t.type),
							(this.finger = !0),
							(this.positions = [this.carpPosition, this.mcpPosition, this.pipPosition, this.dipPosition, this.tipPosition]),
							t.bases ? this.addBones(t) : r.warnBones();
					});
				o.extend(s.prototype, n.prototype),
					(s.prototype.addBones = function (t) {
				...
				var n = t("./hand"),
					...
					h = (e.exports = function (t) {
						if (
							...
							(this.tools = []),
							(this.fingers = []),
							t.interactionBox && (this.interactionBox = new u(t.interactionBox)),
							(this.gestures = []),
							(this.pointablesMap = {}),
							(this._translation = t.t),
							(this._rotation = l.flatten(t.r)),
							(this._scaleFactor = t.s),
							(this.data = t),
							(this.type = "frame"),
							(this.currentFrameRate = t.currentFrameRate),
							t.gestures)
						)
			...
			function (t, e) {
				var n = t("./pointable"),
					...
					u = (e.exports = function (t) {
						(this.id = t.id),
							(this.palmPosition = t.palmPosition),
							(this.direction = t.direction),
							(this.palmVelocity = t.palmVelocity),
							(this.palmNormal = t.palmNormal),
							(this.sphereCenter = t.sphereCenter),
							(this.sphereRadius = t.sphereRadius),
							(this.valid = !0),
							(this.pointables = []),
							(this.fingers = []),
							(this.arm = t.armBasis
							...
							(this.tools = []),
							(this._translation = t.t),
							(this._rotation = a.flatten(t.r)),
							(this._scaleFactor = t.s),
							(this.timeVisible = t.timeVisible),
							(this.stabilizedPalmPosition = t.stabilizedPalmPosition),
							(this.type = t.type),
							(this.grabStrength = t.grabStrength),
							(this.pinchStrength = t.pinchStrength),
		...
		11: [
			function (t, e) {
				e.exports = {
					...
					loop: function (t, e) {
						return (
							t && void 0 === e && "[object Function]" === {}.toString.call(t) && ((e = t), (t = {})),
							this.loopController ? t && this.loopController.setupFrameEvents(t) : (this.loopController = new this.Controller(t)),
							this.loopController.loop(e),
							this.loopController
						);
					},
					plugin: function (t, e) {
		...
		12: [
			function (t, e) {
				...
				(r.prototype.denormalizePoint = function (t) {
					return i.fromValues((t[0] - 0.5) * this.size[0] + this.center[0], (t[1] - 0.5) * this.size[1] + this.center[1], (t[2] - 0.5) * this.size[2] + this.center[2]);
				}),
					(r.prototype.normalizePoint = function (t, e) {
						var n = i.fromValues((t[0] - this.center[0]) / this.size[0] + 0.5, (t[1] - this.center[1]) / this.size[1] + 0.5, (t[2] - this.center[2]) / this.size[2] + 0.5);
				...
				var n = t("gl-matrix"),
					i =
						...
						(e.exports = function (t) {
							(this.valid = !0),
								(this.id = t.id),
								(this.handId = t.handId),
								(this.length = t.length),
								(this.tool = t.tool),
								(this.width = t.width),
								(this.direction = t.direction),
								(this.stabilizedTipPosition = t.stabilizedTipPosition),
								(this.tipPosition = t.tipPosition),
								(this.tipVelocity = t.tipVelocity),
								(this.touchZone = t.touchZone),
								(this.touchDistance = t.touchDistance),
								(this.timeVisible = t.timeVisible);
						}));
			...
			function (t, e, n) {
				...
				var a = (n.JSONProtocol = function (t) {
					...
					return (
						...
						(e.versionLong = "Version " + t.version),
						(e.type = "protocol"),
						r.extend(e, o.prototype),
						e
					);
				});
			},
			...
			function (t, e) {
				...
				(r.prototype.hasPointables = function (t) {
					...
					(r.prototype.listener = function (t) {
						var e = this;
						return (
							t && t.nearThreshold && this.setupNearRegion(t.nearThreshold),
							function (t) {
					...
					(r.prototype.updatePosition = function (t) {
						return (
							this.nearRegion && this.nearRegion.updatePosition(t),
							this.hasPointables(t) && null == this.enteredFrame
								? ((this.enteredFrame = t), this.emit("enter", this.enteredFrame))
								: this.hasPointables(t) || null == this.enteredFrame || ((this.enteredFrame = null), this.emit("exit", this.enteredFrame)),
							t
						);
					}),
				...
				!(function (t) {
					...
					"undefined" == typeof n
						? "function" == typeof define && "object" == typeof define.amd && define.amd
							...
							: (e.exports = "undefined" != typeof window ? window : t)
						: (e.exports = n),
						(function (t) {
							if (!e) var e = 1e-6;
							...
							(a.create = function () {
								...
								(a.forEach = (function () {
									...
									return function (e, n, i, r, o, s) {
										var a, u;
										for (n || (n = 3), i || (i = 0), u = r ? Math.min(r * n + i, e.length) : e.length, a = i; u > a; a += n)
											(t[0] = e[a]), (t[1] = e[a + 1]), (t[2] = e[a + 2]), o(t, t, s), (e[a] = t[0]), (e[a + 1] = t[1]), (e[a + 2] = t[2]);
										return e;
									};
								})()),
								(a.str = function (t) {
							...
							(u.create = function () {
								...
								(u.sub = u.subtract),
								(u.multiply = function (t, e, n) {
									return (t[0] = e[0] * n[0]), (t[1] = e[1] * n[1]), (t[2] = e[2] * n[2]), (t[3] = e[3] * n[3]), t;
								}),
								(u.mul = u.multiply),
								(u.divide = function (t, e, n) {
									return (t[0] = e[0] / n[0]), (t[1] = e[1] / n[1]), (t[2] = e[2] / n[2]), (t[3] = e[3] / n[3]), t;
								}),
								(u.div = u.divide),
								...
								(u.forEach = (function () {
									...
									return function (e, n, i, r, o, s) {
										var a, u;
										for (n || (n = 4), i || (i = 0), u = r ? Math.min(r * n + i, e.length) : e.length, a = i; u > a; a += n)
											(t[0] = e[a]), (t[1] = e[a + 1]), (t[2] = e[a + 2]), (t[3] = e[a + 3]), o(t, t, s), (e[a] = t[0]), (e[a + 1] = t[1]), (e[a + 2] = t[2]), (e[a + 3] = t[3]);
										return e;
									};
								})()),
								(u.str = function (t) {
							...
							(p.create = function () {
								...
								(p.adjoint = function (t, e) {
									var n = e[0],
										...
										g = e[15];
									return (
										(t[0] = a * (p * g - f * v) - h * (u * g - c * v) + m * (u * f - c * p)),
										(t[1] = -(i * (p * g - f * v) - h * (r * g - o * v) + m * (r * f - o * p))),
										(t[2] = i * (u * g - c * v) - a * (r * g - o * v) + m * (r * c - o * u)),
										(t[3] = -(i * (u * f - c * p) - a * (r * f - o * p) + h * (r * c - o * u))),
										(t[4] = -(s * (p * g - f * v) - l * (u * g - c * v) + d * (u * f - c * p))),
										(t[5] = n * (p * g - f * v) - l * (r * g - o * v) + d * (r * f - o * p)),
										(t[6] = -(n * (u * g - c * v) - s * (r * g - o * v) + d * (r * c - o * u))),
										(t[7] = n * (u * f - c * p) - s * (r * f - o * p) + l * (r * c - o * u)),
										(t[8] = s * (h * g - f * m) - l * (a * g - c * m) + d * (a * f - c * h)),
										(t[9] = -(n * (h * g - f * m) - l * (i * g - o * m) + d * (i * f - o * h))),
										(t[10] = n * (a * g - c * m) - s * (i * g - o * m) + d * (i * c - o * a)),
										(t[11] = -(n * (a * f - c * h) - s * (i * f - o * h) + l * (i * c - o * a))),
										(t[12] = -(s * (h * v - p * m) - l * (a * v - u * m) + d * (a * p - u * h))),
										(t[13] = n * (h * v - p * m) - l * (i * v - r * m) + d * (i * p - r * h)),
										(t[14] = -(n * (a * v - u * m) - s * (i * v - r * m) + d * (i * u - r * a))),
										(t[15] = n * (a * p - u * h) - s * (i * p - r * h) + l * (i * u - r * a)),
										t
									);
								}),
								(p.determinant = function (t) {
									var e = t[0],
										...
										k = l * v - p * d,
										P = h * v - p * m;
									return g * P - y * k + w * E + b * F - x * S + M * _;
								}),
								(p.multiply = function (t, e, n) {
									...
									return (
										...
										(t[8] = w * i + b * a + x * h + M * m),
										(t[9] = w * r + b * u + x * p + M * v),
										(t[10] = w * o + b * c + x * f + M * g),
										(t[11] = w * s + b * l + x * d + M * y),
										(w = n[12]),
										(b = n[13]),
										(x = n[14]),
										(M = n[15]),
										(t[12] = w * i + b * a + x * h + M * m),
										(t[13] = w * r + b * u + x * p + M * v),
										(t[14] = w * o + b * c + x * f + M * g),
										(t[15] = w * s + b * l + x * d + M * y),
										t
									);
								}),
								(p.mul = p.multiply),
								(p.translate = function (t, e, n) {
									var i,
										r,
										o,
										s,
									...
									return (
										e === t
											? ((t[12] = e[0] * m + e[4] * v + e[8] * g + e[12]), (t[13] = e[1] * m + e[5] * v + e[9] * g + e[13]), (t[14] = e[2] * m + e[6] * v + e[10] * g + e[14]), (t[15] = e[3] * m + e[7] * v + e[11] * g + e[15]))
											: ((i = e[0]),
											  (r = e[1]),
											  (o = e[2]),
											  (s = e[3]),
											  ...
											  (t[10] = f),
											  (t[11] = d),
											  (t[12] = i * m + a * v + h * g + e[12]),
											  (t[13] = r * m + u * v + p * g + e[13]),
											  (t[14] = o * m + c * v + f * g + e[14]),
											  (t[15] = s * m + l * v + d * g + e[15])),
										t
									);
								}),
								...
								(p.lookAt = function (t, n, i, r) {
									var o,
										...
										_ = i[1],
										S = i[2];
									return Math.abs(v - M) < e && Math.abs(g - _) < e && Math.abs(y - S) < e
										? p.identity(t)
										: ((h = v - M),
										  (f = g - _),
										  (d = y - S),
										  (m = 1 / Math.sqrt(h * h + f * f + d * d)),
										  (h *= m),
										  (f *= m),
										  (d *= m),
										  (o = b * d - x * f),
										  (s = x * h - w * d),
										  (a = w * f - b * h),
										  (m = Math.sqrt(o * o + s * s + a * a)),
										  m ? ((m = 1 / m), (o *= m), (s *= m), (a *= m)) : ((o = 0), (s = 0), (a = 0)),
										  (u = f * a - d * s),
										  (c = d * o - h * a),
										  (l = h * s - f * o),
										  (m = Math.sqrt(u * u + c * c + l * l)),
										  m ? ((m = 1 / m), (u *= m), (c *= m), (l *= m)) : ((u = 0), (c = 0), (l = 0)),
										  (t[0] = o),
										  (t[1] = u),
										  (t[2] = h),
										  (t[3] = 0),
							...
							(f.create = function () {
								...
								(f.rotationTo = (function () {
									...
									return function (i, r, o) {
										var s = a.dot(r, o);
										return -0.999999 > s
											? (a.cross(t, e, r), a.length(t) < 1e-6 && a.cross(t, n, r), a.normalize(t, t), f.setAxisAngle(i, t, Math.PI), i)
											: s > 0.999999
											? ((i[0] = 0), (i[1] = 0), (i[2] = 0), (i[3] = 1), i)
											: (a.cross(t, r, o), (i[0] = t[0]), (i[1] = t[1]), (i[2] = t[2]), (i[3] = 1 + s), f.normalize(i, i));
									};
								})()),
								(f.setAxes = (function () {
									var t = h.create();
								...
								(f.fromMat3 = function (t, e) {
									var n,
										i = e[0] + e[4] + e[8];
									if (i > 0) (n = Math.sqrt(i + 1)), (t[3] = 0.5 * n), (n = 0.5 / n), (t[0] = (e[7] - e[5]) * n), (t[1] = (e[2] - e[6]) * n), (t[2] = (e[3] - e[1]) * n);
									else {
										var r = 0;
		...
		24: [
			function (t, e, n) {
				(function () {
					...
					"undefined" != typeof n ? ("undefined" != typeof e && e.exports && (n = e.exports = F), (n._ = F)) : (t._ = F), (F.VERSION = "1.4.4");
					var E = (F.each = F.forEach = function (t, e, n) {
						if (null != t)
							if (f && t.forEach === f) t.forEach(e, n);
							else if (t.length === +t.length) {
								for (var i = 0, o = t.length; o > i; i++) if (e.call(n, t[i], i, t) === r) return;
							} else for (var s in t) if (F.has(t, s) && e.call(n, t[s], s, t) === r) return;
					});
					...
					(F.reduce = F.foldl = F.inject = function (t, e, n, i) {
						...
						if ((null == t && (t = []), m && t.reduce === m)) return i && (e = F.bind(e, i)), r ? t.reduce(e, n) : t.reduce(e);
						if (
							(E(t, function (t, o, s) {
						...
						(F.reduceRight = F.foldr = function (t, e, n, i) {
							var r = arguments.length > 2;
							if ((null == t && (t = []), v && t.reduceRight === v)) return i && (e = F.bind(e, i)), r ? t.reduceRight(e, n) : t.reduceRight(e);
							var o = t.length;
							if (o !== +o) {
								var s = F.keys(t);
								o = s.length;
					...
					var P = (F.some = F.any = function (t, e, n) {
						e || (e = F.identity);
						var i = !1;
						return null == t
							? i
					...
					(F.contains = F.include = function (t, e) {
						...
						(F.max = function (t, e, n) {
							if (!e && F.isArray(t) && t[0] === +t[0] && t.length < 65535) return Math.max.apply(Math, t);
						...
						(F.min = function (t, e, n) {
							if (!e && F.isArray(t) && t[0] === +t[0] && t.length < 65535) return Math.min.apply(Math, t);
							if (!e && F.isEmpty(t)) return 1 / 0;
							var i = {
								computed: 1 / 0,
								value: 1 / 0
					...
					(F.groupBy = function (t, e, n) {
						...
						(F.toArray = function (t) {
							return t ? (F.isArray(t) ? c.call(t) : t.length === +t.length ? F.map(t, F.identity) : F.values(t)) : [];
						}),
						(F.size = function (t) {
					...
					var q = function (t, e, n) {
						return (
							E(t, function (t) {
								F.isArray(t) ? (e ? u.apply(n, t) : q(t, e, n)) : n.push(t);
							}),
							n
						);
					};
					(F.flatten = function (t, e) {
						...
						(F.without = function (t) {
							return F.difference(t, c.call(arguments, 1));
						}),
						(F.uniq = F.unique = function (t, e, n, i) {
							...
							return (
								E(r, function (n, i) {
									(e ? i && s[s.length - 1] === n : F.contains(s, n)) || (s.push(n), o.push(t[i]));
								}),
								o
							);
						}),
						(F.union = function () {
							return F.uniq(l.apply(o, arguments));
						}),
						...
						(F.zip = function () {
							for (var t = c.call(arguments), e = F.max(F.pluck(t, "length")), n = new Array(e), i = 0; e > i; i++) n[i] = F.pluck(t, "" + i);
							return n;
						}),
						...
						(F.bind = function (t, e) {
							if (t.bind === S && S) return S.apply(t, c.call(arguments, 1));
							var n = c.call(arguments, 2);
							return function () {
						...
						(F.defer = function (t) {
							return F.delay.apply(F, [t, 1].concat(c.call(arguments, 1)));
						}),
						...
						(F.extend = function (t) {
							return (
								E(c.call(arguments, 1), function (e) {
						...
						(F.omit = function (t) {
							var e = {},
								n = l.apply(o, c.call(arguments, 1));
							for (var i in t) F.contains(n, i) || (e[i] = t[i]);
							return e;
						}),
					...
					var I = function (t, e, n, i) {
						...
						var s = 0,
							a = !0;
						if ("[object Array]" == r) {
							if (((s = t.length), (a = s == e.length))) for (; s-- && (a = I(t[s], e[s], n, i)); );
						} else {
							var u = t.constructor,
								c = e.constructor;
							if (u !== c && !(F.isFunction(u) && u instanceof u && F.isFunction(c) && c instanceof c)) return !1;
							for (var l in t) if (F.has(t, l) && (s++, !(a = F.has(e, l) && I(t[l], e[l], n, i)))) break;
							if (a) {
								for (l in e) if (F.has(e, l) && !s--) break;
								a = !s;
							}
						}
					...
					C.unescape = F.invert(C.escape);
					var L = {
						escape: new RegExp("[" + F.keys(C.escape).join("") + "]", "g"),
						unescape: new RegExp("(" + F.keys(C.unescape).join("|") + ")", "g")
					};
					F.each(["escape", "unescape"], function (t) {
						F[t] = function (e) {
							return null == e
								? ""
								: ("" + e).replace(L[t], function (e) {
										return C[t][e];
								  });
						};
					}),
						...
						(F.mixin = function (t) {
							E(F.functions(t), function (e) {
								var n = (F[e] = t[e]);
								F.prototype[e] = function () {
									var t = [this._wrapped];
									return u.apply(t, arguments), B.call(this, n.apply(F, t));
								};
							});
						});
					var j = 0;
					...
					(F.template = function (t, e, n) {
						...
						t.replace(r, function (e, n, i, r, a) {
							return (
								(s += t.slice(o, a).replace(V, function (t) {
									return "\\" + O[t];
								})),
	...
	(function () {
		var t = function () {
			...
			var t = function (t) {
				var e = t.hands[0];
				if (!e) return void this.updatePosition(-this.config.cursorSize, -this.config.cursorSize);
				var n = t.interactionBox.normalizePoint(e.palmPosition),
					i = Math.min(Math.max(n[0], 0), 1),
					r = 1 - Math.min(Math.max(n[1], 0), 1),
					o = i * (window.document.documentElement.clientWidth - this.config.cursorSize),
					s = r * (window.document.documentElement.clientHeight - this.config.cursorSize);
				if ((this.updatePosition(o, s), e.grabStrength > this.config.grabThreshold && Date.now() - this.lastClickedTime > 2e3)) {
					console.log("clicked"), (this.lastClickedTime = new Date()), this.activeEffect();
					var a = document.elementsFromPoint(o + this.config.cursorSize / 2, s + this.config.cursorSize / 2)[1];
					a && a.click();
				}
				1 === r ? window.scroll(window.scrollX, window.scrollY + this.config.scrollSpeed) : 0 === r && window.scroll(window.scrollX, window.scrollY - this.config.scrollSpeed),
					1 === i ? window.scroll(window.scrollX + this.config.scrollSpeed, window.scrollY) : 0 === i && window.scroll(window.scrollX - this.config.scrollSpeed, window.scrollY);
			};
			...
			Leap.loop(e, t.bind(this));
		};
		window && (window.LeapMouse = t);
	})();
